 ...
 public:
  struct CommonFeatureValue {
    ...
    __host__ __device__ int Dim(int mf_dim) {
      ...
      } else if (mf_optimizer_type_ == 2) { // std_adagrad
...
/*
__device__ void PushValueInit(float* dest_val, const float* src_val) {
  dest_val[common_push_value.SlotIndex()] = -1;
