...
// init inter comm
  ...
  void SetPullFeatureSlotNum(int sparse_slot_num, int float_slot_num, int edge_sparse_slot_num, int edge_float_slot_num) {
    ...
    gpu_graph_ptr->set_feature_info(slot_num_for_pull_feature_, float_slot_num_, edge_slot_num_for_pull_feature_, edge_float_slot_num_);
