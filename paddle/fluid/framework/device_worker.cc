...
template <typename T>
std::string PrintLodTensorType(const phi::DenseTensor* tensor,
                               int64_t start,
                               int64_t end,
                               char separator = ',',
...
template <typename T>
void PrintLodTensorType(const phi::DenseTensor* tensor,
                        int64_t start,
                        int64_t end,
...
template <>
void PrintLodTensorType<float>(const phi::DenseTensor* tensor,
                               int64_t start,
                               int64_t end,
                               std::string& out_val,  // NOLINT
                               char separator,
...
std::string PrintLodTensorIntType(const phi::DenseTensor* tensor,
                                  int64_t start,
                                  int64_t end,
                                  char separator = ',',
                                  bool need_leading_separator = true) {
...
void PrintLodTensorIntType(const phi::DenseTensor* tensor,
                           int64_t start,
                           int64_t end,
                           std::string& out_val,  // NOLINT
                           char separator = ',',
...
std::string PrintLodTensor(const phi::DenseTensor* tensor,
                           int64_t start,
                           int64_t end,
                           char separator,
                           bool need_leading_separator) {
...
void PrintLodTensor(const phi::DenseTensor* tensor,
                    int64_t start,
                    int64_t end,
                    std::string& out_val,  // NOLINT
                    char separator,
...
#endif
      field_num,
      [this, &dims, &cpu_tensors, &lods, &scope, batch_size](const size_t& i) {
