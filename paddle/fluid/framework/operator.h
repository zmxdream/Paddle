...
class OperatorBase {
 public:
  ...
  virtual void RuntimeInferShape(const int ii, const int dev_id, const Scope& scope) const {}
  // virtual void SetOutputsLoD(const std::string& out,
  //                    const std::vector<framework::LoD>& lods) const {}
...
class OperatorWithKernel : public OperatorBase {
 public:
  ...
  // void SetOutputsLoD(const std::string& out,
  //                    const std::vector<framework::LoD>& lods) const override;
  void RuntimeInferShape(const int ii, const int dev_id, const Scope& scope) const;
...
class RuntimeInferShapeContext : public InferShapeContext {
 public:
  ...
  void SetOutputsLoD(const std::string& in, const std::string& out,
                     std::vector<framework::LoD>& lods) override;
