...
class FusedSeqpoolCVMOpWithCredit : public framework::OperatorWithKernel {
 public:
...
class FusedSeqpoolCVMOpWithCreditMaker
 ...
 public:
  void Make() override {
    ...
    AddAttr<int>("cvm_offset", "(int, default 4)").SetDefault(4);
...
class FusedSeqpoolCVMGradOpWithCredit : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;
...
class FusedSeqpoolCVMGradOpWithCreditMaker
 ...
 protected:
  void Apply(GradOpPtr<T> op_desc_ptr) const override {
    op_desc_ptr->SetType("fused_seqpool_cvm_with_credit_grad");
...
REGISTER_OP_CPU_KERNEL(fused_seqpool_cvm_with_credit_grad,
                       ops::FusedSeqpoolCVMGradOpWithCreditCPUKernel<float>)
