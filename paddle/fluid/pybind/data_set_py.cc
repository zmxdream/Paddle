...
void BindDataset(py::module *m) {
  py::class_<framework::Dataset, std::unique_ptr<framework::Dataset>>(*m,
      ...
      .def("set_filelist",
           ...
           py::call_guard<py::gil_scoped_release>())
      .def("set_index_filelist",
           &framework::Dataset::SetIndexFileList,
           py::call_guard<py::gil_scoped_release>())
      .def("set_thread_num",
      ...
      .def("enable_pv_merge",
           ...
           py::call_guard<py::gil_scoped_release>())
	  .def("disable_polling", &framework::Dataset::SetDiablePolling,
           py::call_guard<py::gil_scoped_release>())
      .def("disable_shuffle", &framework::Dataset::SetDisableShuffle,
           py::call_guard<py::gil_scoped_release>())
      .def("preload_into_disk", &framework::Dataset::PreLoadIntoDisk,
           py::call_guard<py::gil_scoped_release>())
      .def("wait_load_disk_done", &framework::Dataset::WaitLoadDiskDone,
           py::call_guard<py::gil_scoped_release>())
      .def("set_archivefile", &framework::Dataset::SetLoadArchiveFile,
           py::call_guard<py::gil_scoped_release>())
