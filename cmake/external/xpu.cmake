...
if (WITH_BOX_PS OR WITH_XPU_KP)
    ...
    set(XPU_XRE_URL
        ...
        CACHE STRING "" FORCE)
    set(XPU_XCCL_URL
        "https://klx-sdk-release-public.su.bcebos.com/xccl/release/1.1.8.1/${XPU_XCCL_DIR_NAME}.tar.gz"
        CACHE STRING "" FORCE)
    #"https://klx-sdk-release-public.su.bcebos.com/xdnn/release/2.6.0.1/${XPU_XDNN_DIR_NAME}.tar.gz"
    set(XPU_XDNN_URL
        "https://klx-sdk-release-public.su.bcebos.com/xdnn_train/dev/paddlebox/20240124/${XPU_XDNN_DIR_NAME}.tar.gz"
        CACHE STRING "" FORCE)
    set(SCALOPUS_URL
